...
def navigation_policy(waypoint_index, navigator):
    ...
    '''
    waypoints = [(2.0, 0.5), (-2.0, -1.0), (1.0, 1.0)]
...
if __name__ == '__main__':
    ...
    # Setup multigrid environment
    register(id='multigrid-nav2-demo',
             entry_point='multigrid_envs:Nav2Demo4HEnv24x24N2')
    ...
    for i in range(3):
        ...
        while not navigator.isNavComplete():
            ...
            if abs(previous_x - current_x) >= 0.25:
            ...
            if abs(previous_y - current_y) >= 0.25:
